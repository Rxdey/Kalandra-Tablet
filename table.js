...
function constructResult(configuration, input_tablet){
    ...
    html += '<div style="text-align:center;"><font size="4"><span><b> 修改方法 </b></span></font></div>';
    html += '<div class="result_table">';
    _html += '<div style="text-align:center;"><font size="4"><span><b> 预览 </b></span></font></div>';
    ...
    html += '<div><span>普通: </span><span class="green">' + configuration[1] + '</span></div>';
    html += '<div><span>添加: </span><span class="yellow">' + configuration[2] + '</span></div>';
    html += '<div><span>删除: </span><span class="red">' + configuration[3] + '</span></div>';
    html += '</div></div>';

    _html += '</div>';
    _html += '<div class="result_text">';
    _html += '<div><span>普通: </span><span class="green">' + configuration[1] + '</span></div>';
    _html += '<div><span>添加: </span><span class="yellow">' + configuration[2] + '</span></div>';
    _html += '<div><span>删除: </span><span class="red">' + configuration[3] + '</span></div>';
    _html += '</div></div>';
...
$(document).ready(function () {
    ...
    let top_configurations_3x4 = [3997, 3773, 3995, 2011, 3871, 2975, 3487, 3518, 3983, 3031]
    let top_configurations_4x3 = [3949, 3919, 3934, 3695, 3311, 2927, 3887, 1967, 3943, 3955]
    let top_configurations_4x4 = [63901, 63899, 63775, 61855, 47519, 55711, 63647, 63887, 63957, 61911, 63930, 63678, 60303, 43935, 32031, 23967, 32186, 32062, 31934, 23998, 60373, 60359, 58327, 43991]
    ...
    $('#button').on('click', function () {
        ...
        if(bitNumber(table_configuration) > 17){
            ...
            if (row == 3 && col == 4)
                top_configurations = top_configurations_3x4
            if (row == 4 && col == 3)
                top_configurations = top_configurations_4x3
            if (row == 4 && col == 4)
                top_configurations = top_configurations_4x4
